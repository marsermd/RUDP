...
class StringMessageDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<StringMessage>
      _instance;
...
void InitDefaultsStringMessageImpl() {
  ...
  {
    void* ptr = &::_StringMessage_default_instance_;
    new (ptr) ::StringMessage();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::StringMessage::InitAsDefaultInstance();
}

void InitDefaultsStringMessage() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsStringMessageImpl);
}
...
StringMessage::StringMessage()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_StringMessage_2eproto::InitDefaultsStringMessage();
  }
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::StringMessage* Arena::Create< ::StringMessage >(Arena* arena) {
  return Arena::CreateInternal< ::StringMessage >(arena);
}
}  // namespace protobuf
}  // namespace google
